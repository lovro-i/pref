...
public class Factor extends FactorBase implements Cloneable {
  ...
  protected @Nullable
  ISolverFactor _solverFactor = null;
  private FactorFunction _factorFunction;
  protected @Nullable
  int[] _directedTo = NOT_YET_SET;
  @Nullable
...
//	}
   ...
   * <p>
   * For {@link DiscreteFactor}s, this will replace the factor function with one
   * using a newly generated factor table. For other factor types this wraps the
   * factor function with {@link FactorFunctionWithConstants}.
   * </p>
   *
  ...
  /**
   * Replaces factor function conditioned on a set of variables with fixed
   * values that have already been removed from the factor. This should only be
   * called from within {@link #removeFixedVariables()}.
   * <p>
   * This is invoked after the fixed value variables have already been
   * disconnected from the factor, but before the factor function has been
   * replaced.
   * <p>
