...
public class SumProductSolverGraph extends SFactorGraphBase {
  ...
  private @Nullable
  Map<IFactorTable, FactorTableUpdateSettings> _factorTableUpdateSettings;

  @Nullable
  FactorTableUpdateSettings getFactorTableUpdateSettings(Factor factor) {
  ...
  /**
   * @deprecated Will be removed in a future release. Instead set
   * {@link GibbsOptions#numSamples} on this object using {@link #setOption}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Will be removed in a future release. Instead get
   * {@link GibbsOptions#numSamples} on from this object using
   * {@link #getOption}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Will be removed in a future release. Instead set
   * {@link GibbsOptions#burnInScans} on this object using {@link #setOption}.
   */
  @Deprecated
  ...
  /**
   * @deprecated Will be removed in a future release. Instead set
   * {@link GibbsOptions#scansPerSample} on this object using
   * {@link #setOption}.
   */
  @Deprecated
  ...
  int[][] convertObjects2Indices(Variable[] vars, Object[][] data) {
  ...
  public @Nullable
  IFactorTable getCurrentFactorTable() {
