...
public class MixtureTest1 {
  ...
  public static void randomTest() throws Exception {
    ...
    Logger.info("C1 to C2: " + KendallTauRankingDistance.getInstance().distance(model1.getCenter(), model2.getCenter()));
    Logger.info("C1 to C3: " + KendallTauRankingDistance.getInstance().distance(model1.getCenter(), model3.getCenter()));
    Logger.info("C2 to C3: " + KendallTauRankingDistance.getInstance().distance(model2.getCenter(), model3.getCenter()));
