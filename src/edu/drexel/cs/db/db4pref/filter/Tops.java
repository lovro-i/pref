...
/** Utility class that represents distribution of ranking lengths. Used for generating a sample of top-k rankings with the specified distribution of k values  */
public class Tops {
