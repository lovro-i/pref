...
public class State4 {
  ...
  public State4(Expander4 expander) {
  ...
  private State4(Expander4 expander, Item[] items) {
    this.expander = expander;
  ...
  private State4(Expander4 expander, State4 e) {
    this.expander = expander;
   ...
   */
  public void insertMissing(Expands4 expands, Item item, double p1) {
    int step = expander.referenceIndex.get(item);
    int pos = 0;
    for (int i = 0; i < this.miss.length; i++) {
      State4 state = new State4(expander, this);
      state.miss[i]++;
  ...
  public void insert(Expands4 expands, Item item, boolean missing, double p) {
  ...
  private void insertOne(Expands4 expands, Item item, int index, double p1) {
    ...
    for (int i = 0; i < n; i++) {
      State4 state = new State4(expander, items1);
  ...
  public void insert(Expands4 expands, Item item, double p1) {
    Span hilo = hilo(item);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof State4)) return false;
    State4 e = (State4) o;
