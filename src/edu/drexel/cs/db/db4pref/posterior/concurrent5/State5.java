...
public class State5 {
  ...
  public State5(Expander5 expander) {
  ...
  private State5(Expander5 expander, Item[] items) {
    this.expander = expander;
  ...
  private State5(Expander5 expander, State5 e) {
    this.expander = expander;
   ...
   */
  public void insertMissing(Expands5 expands, Item item, double p1) {
    int step = expander.referenceIndex.get(item);
    int pos = 0;
    for (int i = 0; i < this.miss.length; i++) {
      State5 state = new State5(expander, this);
      state.miss[i]++;
  ...
  public void insert(Expands5 expands, Item item, boolean missing, double p) {
  ...
  private void insertOne(Expands5 expands, Item item, int index, double p1) {
    ...
    for (int i = 0; i < n; i++) {
      State5 state = new State5(expander, items1);
  ...
  public void insert(Expands5 expands, Item item, double p1) {
    Span hilo = hilo(item);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof State5)) return false;
    State5 e = (State5) o;
