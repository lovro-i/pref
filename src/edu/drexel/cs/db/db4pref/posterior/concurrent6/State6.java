...
public class State6 {
  ...
  public State6(Expander6 expander) {
  ...
  private State6(Expander6 expander, Item[] items) {
    this.expander = expander;
  ...
  private State6(Expander6 expander, State6 e) {
    this.expander = expander;
   ...
   */
  public void insertMissing(Expands6 expands, Item item, double p1) {
    int step = expander.referenceIndex.get(item);
    int pos = 0;
    for (int i = 0; i < this.miss.length; i++) {
      State6 state = new State6(expander, this);
      state.miss[i]++;
  ...
  public void insert(Expands6 expands, Item item, boolean missing, double p) {
  ...
  public Span hilo(Item item) {
    ...
    for (int j = 0; j < items.length; j++) {
      ...
      else if (lower.contains(it) && j < high) {
        high = j;
      }
    }
  ...
  private void insertOne(Expands6 expands, Item item, int index, double p1) {
    ...
    for (int i = 0; i < n; i++) {
      State6 state = new State6(expander, items1);
  ...
  public void insert(Expands6 expands, Item item, double p1) {
    Span hilo = hilo(item);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof State6)) return false;
    State6 e = (State6) o;
