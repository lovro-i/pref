...
/** Base class for all EM Reconstructors */
public abstract class EMReconstructor implements MallowsReconstructor {
  ...
  protected abstract MallowsPosteriorSampler initSampler(Sample<? extends PreferenceSet> sample);
  
  protected abstract MallowsPosteriorSampler updateSampler(MallowsPosteriorSampler sampler, MallowsModel estimate, Sample<? extends PreferenceSet> sample, Sample<? extends PreferenceSet> resample);
  ...
  public MallowsModel reconstruct(Sample<? extends PreferenceSet> sample, Ranking center) {
    ...
    MallowsPosteriorSampler sampler = initSampler(sample);
