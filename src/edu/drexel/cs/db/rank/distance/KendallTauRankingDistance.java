...
public class KendallTauRankingDistance implements RankingDistance {
  
  private static KendallTauRankingDistance distance = new KendallTauRankingDistance();
  
  public KendallTauRankingDistance() {    
  }
  
  public static KendallTauRankingDistance getInstance() {
    return distance;
  }
  ...
  public static void main(String[] args) {
    ...
    KendallTauRankingDistance dist = new KendallTauRankingDistance();
