...
/** Tests the correlation between LogLikelihood measure and PPM distance */
public class LogLikelihoodAndPPM {
  ...
  public static void main1(String[] args) throws IOException {
    ...
    File file = new File(folder, "Measure.correlation.csv");
    
    File png = new File(folder, "Measure.correlation.png");
    plot(file, png);
...
//      out.println(String.format("%.6f, %.6f", PPMDistance.distance(sample1, sample2), model1.getLogLikelihood(sample2)));
//      out.println(String.format("%.6f, %.6f", PPMDistance.distance(sample1, sample3), model1.getLogLikelihood(sample3)));
//      out.println(String.format("%.6f, %.6f", PPMDistance.distance(sample1, sample4), model1.getLogLikelihood(sample4)));
//      out.println(String.format("%.6f, %.6f", PPMDistance.distance(sample2, sample3), model2.getLogLikelihood(sample3)));
//      out.println(String.format("%.6f, %.6f", PPMDistance.distance(sample2, sample4), model2.getLogLikelihood(sample4)));
//      out.println(String.format("%.6f, %.6f", PPMDistance.distance(sample3, sample4), model3.getLogLikelihood(sample4)));
      out.flush();
